...
CacheAllocator<CacheTrait>::findEviction(PoolId pid, ClassId cid) {
  ...
  while ((config_.evictionSearchTries == 0 ||
    ...
    Item* candidate = toRecycle->isChainedItem()
    ...
    auto toReleaseHandle = evictNormalItem(*candidate, true /* skipIfTokenInvalid */);
...
template <typename CacheTrait>
typename CacheAllocator<CacheTrait>::WriteHandle
CacheAllocator<CacheTrait>::evictNormalItem(Item& item, bool skipIfTokenInvalid) {
